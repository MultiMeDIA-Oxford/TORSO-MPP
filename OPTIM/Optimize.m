...
%   GO.FIXED_COORDINATES             =  [];
  ...
  DP.COORDINATES_ORDER             = @(N) 1:N; %randperm(N);   % 1:N
...
%   J( GO.FIXED_COORDINATES ) = 0;
  ...
  if GO.PLOT
    ...
    PLOT.hFig = figure( 'Units','pixels'                                ,...
                        ...
                        'Interruptible','on'                            ,...
                        'BusyAction','cancel'                           ,...
                        'Position',[100 200 600 300]                    ,...
                        'NumberTitle','off'                             ,...
                        'Name','Optimizing' );
    try, AlwaysOnTopButton( PLOT.hFig ); end
...
%     lims = objbounds( get(g,'children') );
  ...
  function updateX( varargin )
    ...
    if GO.SAVE_IN_BASE, setappdata( 0 , 'OPTIMIZE_X' , R(x) ); end
