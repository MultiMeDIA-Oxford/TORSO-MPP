function V = gmshfn2( S , varargin )

  OPTS = struct();

OPTS.Mesh.ElementOrder = 1;
OPTS.Mesh.Algorithm3D = 2;
OPTS.Mesh.CharacteristicLengthExtendFromBoundary = 0.4;
OPTS.Mesh.Optimize = 1;
%OPTS.Mesh.OptimizeNetgen = 1;
OPTS.Mesh.CharacteristicLengthFromPoints = 1;
OPTS.Mesh.CharacteristicLengthFromCurvature = 0;
 OPTS.Mesh.CharacteristicLengthMin = 0.2;
 OPTS.Mesh.CharacteristicLengthMax = 0.4;
% OPTS.Mesh.Algorithm = 6;
OPTS.Mesh.OptimizeThreshold = 0.4;
