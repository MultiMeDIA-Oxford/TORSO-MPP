...
%   
  ...
  if isstruct( I ) && isfield( I , 'xyz' ) && isfield( I , 'tri' )
    
    [M,iM] = getPlane( I.xyz(unique(I.tri(:)),:) , varargin{:} );
    return;
    
  elseif isstruct( I ) && isfield( I , 'xyz' )
    
    [M,iM] = getPlane( I.xyz , varargin{:} );
    return;
...
%     if 1
      ...
      P = R * [ mean( I.X([1 end]) ) ; mean( I.Y([1 end]) ) ; I.Z(1) ] + I.SpatialTransform(1:3,4);
